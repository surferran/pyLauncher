'''
 ...
 started:  01/02/2016
 desire:
    to allow lunch of specific user-fit windows applications
    and to custon-fit the usage statistic to better quicker shortcut displays.
'''
##
'''
helping links :
...
minimize example are taken from :
...
https://www.daniweb.com/programming/software-development/code/216962/led-clock-using-wxpython
